!(function () {
          ...
          function u(e, t) {
            ...
            if (t.plugins)
              for (var u = 0; u < t.plugins.length; u++)
                (k = t.plugins[u]).processTemplate &&
                  (e = k.processTemplate(e, t));
            function m(e, r) {
              e &&
                (e = i(e, t, o, r)) &&
            ...
            if ((m(e.slice(a, e.length), !1), t.plugins))
              for (u = 0; u < t.plugins.length; u++) {
                var k;
                (k = t.plugins[u]).processAST && (n = k.processAST(n, t));
              }
            return n;
          }
          function m(e, t) {
    ...
    _updateVariationProps() {
      ...
      this.skus.forEach((e) => {
        ...
        this.unitPrices.forEach((e) => {
          e.innerHTML = $(this.variation.unit_price);
        }),
      ...
      return d(function* () {
        ...
        try {
          ...
          if (((t.submit.value = t.normalAddToCartText), 200 != a.status)) {
            var s = (yield a.json()).description;
            throw (
              (t.errorWrapper &&
  ...
  var C = x("udesly-recommendeds", "db"),
    A = (function e(t) {
  ...
  const Q = "undefined" != typeof window ? window : {},
    ...
    xe = (e, t, r, n, o, i) => {
      ...
      for (s.shadowRoot && s.tagName === D && (s = s.shadowRoot); o <= i; ++o)
        n[o] &&
          ((a = be(null, r, o, e)),
          a && ((n[o].$elm$ = a), s.insertBefore(a, ke(t))));
    },
    Ee = (e, t, r, n, o) => {
      for (; t <= r; ++t)
        (n = e[t]) &&
    ...
    ke = (e) => (e && e["s-ol"]) || e,
    Ce = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode,
    Ae = (e, t) => {
      const r = (t.$elm$ = e.$elm$),
        n = e.$children$,
        o = t.$children$,
                ...
                for (; a <= d && s <= m; )
                  if (null == p) p = t[++a];
                    ...
                    c >= 0
                      ...
                      o && Ce(p.$elm$).insertBefore(o, ke(p.$elm$));
                  }
                a > d
